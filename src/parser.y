...
fnargs_list:
    identifier nws                                                                                 { $$ = ast_FnArgsList(NULL, $1); }
    | identifier "," nws                                                                           { $$ = ast_FnArgsList(NULL, $1); }
    | identifier "," nws fnargs_list                                                               { $$ = ast_FnArgsList($4, $1); }
    ;
...
assignment_expression:
    ...
    | postfix_expression "=" "const" assignment_expression                                         { $$ = ast_Expression(TOKOP_ASSIGN_CONST, $1, $4, NULL); }
    | postfix_expression "=" "weak" assignment_expression                                          { $$ = ast_Expression(TOKOP_ASSIGN_WEAK, $1, $4, NULL); }
    | postfix_expression "=" "const" "weak" assignment_expression                                  { $$ = ast_Expression(TOKOP_ASSIGN_CONST_WEAK, $1, $5, NULL); }
    | postfix_expression "=" "weak" "const" assignment_expression                                  { $$ = ast_Expression(TOKOP_ASSIGN_CONST_WEAK, $1, $5, NULL); }
    | postfix_expression "||=" assignment_expression                                               { $$ = ast_Expression($2, $1, $3, NULL); }
    | postfix_expression "&&=" assignment_expression                                               { $$ = ast_Expression($2, $1, $3, NULL); }
    | postfix_expression "|=" assignment_expression                                                { $$ = ast_Expression($2, $1, $3, NULL); }
    | postfix_expression "^=" assignment_expression                                                { $$ = ast_Expression($2, $1, $3, NULL); }
